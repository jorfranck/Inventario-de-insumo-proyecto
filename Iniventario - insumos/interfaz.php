    ...
    <main>
        <div class="div-menu">
            <ul>
                ...
                <a href="listar-insumos.php" class="opc">Listar Suministros <i class="bi bi-list-check"></i></a>
                <a href="buscar-insumo.php" class="opc">Buscar Suministro <i class="bi bi-search"></i></a>
                <?php if($auth):  ?>
